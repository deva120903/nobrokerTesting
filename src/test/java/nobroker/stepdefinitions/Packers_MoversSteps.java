...
public class Packers_MoversSteps {
    ...
    public void verify_alert_message() {
		 ...
		 * "Expected an alert but none displayed!"); if (alert) { String msg =
		 * moversPage.getAlertMessage(); System.out.println("Alert text: " + msg); }
		 */
    }
    ...
    public void add_items() {
		/*
		 * boolean added = moversPage.addItems(); Assert.assertTrue(added,
		 * "Items not added"); Base.sleep(1000);
		 */
    }
